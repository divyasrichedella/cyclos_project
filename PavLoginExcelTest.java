...
public class PavLoginExcelTest {
	...
	@Test(dataProvider = "excel-inputs", dataProviderClass = PavLoginDataProviders.class)
	public void loginDBTest(String userName, String password) {
		pavLoginPOM.sendUserName(userName);
		//loginPOM.sendPassword(password);
		pavLoginPOM.clickLoginBtn();
